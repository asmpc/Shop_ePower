...
class TestsManagerInvoiceDetailAPI(TestCase):
    ...
    # может получить информацию о счёте.
    def test_manager_can_get_invoice_detail(self):
        self.client.force_authenticate(
            user=self.manager,
        )

        url = reverse(
            "api-payments:manager-invoice-detail",
            kwargs={
    ...
    # может получить информацию о счёте.
    def test_admin_can_get_invoice_detail(self):
        self.client.force_authenticate(
            user=self.admin,
        )
    ...
    # не может получить информацию о счёте.
    def test_client_cannot_get_invoice_detail(self):
        self.client.force_authenticate(
            user=self.client_user,
        )
    ...
    # не может получить информацию о счёте.
    def test_anonymous_cannot_get_invoice_detail(self):
        url = reverse(
            "api-payments:manager-invoice-detail",
            kwargs={
                "invoice_id": self.invoice.pk,
    ...
    def test_returns_404_if_invoice_not_found(self):
        self.client.force_authenticate(
            user=self.manager,
        )
